# -*- coding: utf-8 -*-
"""
Created on Sun Apr 25 20:55:14 2021

@author: Nandan Mallela
"""
...
class RecordVideo(QtCore.QObject):
    ...
    def _init_(self, camera_port, parent=None):
        super()._init_(parent)
...
class FaceDetectionWidget(QtWidgets.QWidget):
    def _init_(self, cascade_filepath, parent=None):
        super()._init_(parent)
...
class MainWidget(QtWidgets.QWidget):
    def _init_(self, haarcascade_filepath, parent=None):
        super()._init_(parent)
